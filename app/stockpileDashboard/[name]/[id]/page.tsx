...
export default function DashboardPage() {
  ...
  const handleQueryReport = async () => {
    try {
      ...
      const stockpileData = await runStockpileReport(
        sitedata as ReportItem,
        { startTime: startTime as string, endTime: endTime as string },
        stockpileNumber as string,
      );
                  ...
                  <div className="flex flex-col md:flex-row items-end gap-4 w-full">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="stockpile-toggle">
                          Add Stockpile Number (optional)
                        </Label>
                      </div>
