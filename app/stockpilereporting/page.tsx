    ...
    client.models.Sites.observeQuery().subscribe({
      next: (data) => {
        const sites = data.items
          ...
          .filter((site) => site?.siteConstants?.reporttype === "stockpile")
          .sort(); // Filter where reporttype is telegram;
        ...
        <Checkbox
          ...
          onCheckedChange={async (checked) => {
            ...
            try {
              ...
              console.error(
                `Failed to update audit status for site ID: ${siteId}`,
                err,
              );
            }
          }}
      ...
      <main className="flex-1 p-1 h-f mt-20">
        ...
        {loading ? (
          ...
          <>
            ...
            <DataTable title={"Stockpiles"} data={data} columns={columns} />
          </>
        )}
